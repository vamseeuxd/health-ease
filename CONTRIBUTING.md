# Contributing to health-ease

We would love for you to contribute to health-ease and help make it ever better together! :rocket:
...
Help us keep health-ease open and inclusive. Please read and follow our [Code of Conduct][coc].

## <a name="question"></a> Got a Question or Problem?

Please do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [StackOverflow][stackoverflow] where the questions should be tagged with tag `health-ease`.
...
* If you have a question about using health-ease, please ask on the [StackOverflow][stackoverflow].
...
* In GitHub, send a pull request to `health-ease:master`.
...
we use the git commit messages to **generate the health-ease change log**.
...
[dev-doc]: DEV_DOCS.md
[github]: https://github.com/akveo/health-ease
[stackoverflow]: https://stackoverflow.com/questions/tagged/health-ease
[issues]: https://github.com/akveo/health-ease/issues
[new_issue]: https://github.com/akveo/health-ease/issues/new
[pulls]: https://github.com/akveo/health-ease/pulls
